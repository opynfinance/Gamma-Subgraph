...
export function handleFillOrder(event: LimitOrderFilled): void {
  ...
  fill.senderAddress = Address.fromString(ZERO_ADDRESS)
  ...
  fill.makerAssetData = ZERO_ADDRESS
  fill.takerAssetData = ZERO_ADDRESS

  log.info('Fill params: {}, {}, {}, {}, {}, {}, {}, {}, {}', [
    fill.transactionHash.toHexString(),
    fill.timestamp.toString(),
    fill.makerAddress.toHexString(),
    fill.takerAddress.toHexString(),
